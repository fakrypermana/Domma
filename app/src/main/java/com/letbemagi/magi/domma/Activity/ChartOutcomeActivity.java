...
public class ChartOutcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_outcome);

        loadDataTrans();

        GraphView bar_graph = findViewById(R.id.gvOutcome);
        for (int i = 0; i < listTransaction.size(); i++) {
            if (listTransaction.get(i).getType() == 1) {
